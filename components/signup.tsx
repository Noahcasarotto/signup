...
* @see https://v0.dev/t/zy0x1ZKGppq
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-24">
          <div className="flex flex-col justify-center space-y-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <p className="text-muted-foreground">Free 60-day trial</p>
            </div>
          </div>
          <Card className="w-full max-w-md mx-auto">
            <CardHeader>
              <CardTitle>Sign Up</CardTitle>
              <CardDescription>Create your account to start using our platform. Free 60-day trial.</CardDescription>
            </CardHeader>
